    ...
    <section className="py-12 md:py-16 bg-white">
      <div className="max-w-6xl mx-auto px-5">
        <div className="text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">限量服务，专注品质</h2>
          <div className="space-y-6">
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
              我们每月最多支持 <span className="font-bold text-indigo-600 text-2xl">5 个 Web3 项目</span>，
              以保证每个项目都有足够投入。
            </p>
            <div className="inline-block bg-gradient-to-r from-red-50 to-orange-50 border-2 border-red-200 rounded-lg p-6 md:p-8 shadow-md">
              <p className="text-gray-600 mb-4 text-lg font-semibold">本期申请截止倒计时</p>
